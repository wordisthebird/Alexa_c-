    ...
    public class Function
    {
        ...
        public async Task<SkillResponse> FunctionHandler(SkillRequest input, ILambdaContext context)
        {
            ...
            if (requestType == typeof(IntentRequest))
            {
                ...
                var outputText = $"You'd like more information about {countryInfo.name}. The capital is {countryInfo.capital}.";
                return MakeSkillResponse(outputText, true);
            }
            else
            {
                return MakeSkillResponse(
                        $"I don't know how to handle this inteca[nt. Please say something like Alexa, ask {INVOCATION_NAME} about Canada.",
                        true);
            }
        }
